...
if __name__ == "__main__":
    ...
    for seed in [1, 2, 3]:
        os.system(f"bash base2new_train.sh ucf101 {seed} {args.gpuids} {args.l} {args.epochs}")
        os.system(f"bash base2new_test.sh ucf101 {seed} {args.gpuids} {args.l} {args.epochs}")
